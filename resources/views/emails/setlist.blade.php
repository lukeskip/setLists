...
<table style="width:100%; border-radius: 5px;" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <br><br>
    <img src="{{asset('img/logo_setlist.png')}}" width="350" alt="">
...
@endforeach
  ...
  <tr style="background: #AF0929; padding: 40px">
    ...
    <th style="padding: 40px"><img src="{{asset('img/logo_rey.png')}}" width="150" alt=""><br>Rey Decibel, todos los derechos reservados, 2017</th>
  </tr>
</table>
</div>
